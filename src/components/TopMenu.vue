...
//        tlLogoSize.fromTo($logo, part1time,
//            {attr: {viewBox: '0 0 219 53'}},
//            {attr: {viewBox: '0 0 219 42'}}
//        )
//        tlLogoSize.add(TweenMax.fromTo($logo, part1time,
//            {width: 219, height: 53},
//            {width: 239, height: 42}
        ...
        <!--<div id="header-logo" class="header item">-->
          <!--<a href="/">-->
            <!--<svg id="header-logo-svg" width="219px" height="53px" viewBox="0 0 219 53" version="1.1"-->
              ...
              <!--&lt;!&ndash; Generator: Sketch 41.2 (35397) - http://www.bohemiancoding.com/sketch &ndash;&gt;-->
                    ...
                    <!--<g id="adminoid/header/full/logo/texts" transform="translate(58.000000, 0.000000)">-->
                      <!--<g id="Logo-text" transform="translate(0.000000, -1.000000)">-->
                        <!--<g id="webmaster" transform="translate(34.000000, 0.000000)">-->
                          <!--<rect id="Rectangle-21" fill-opacity="0.900000036" fill="url(#linearGradient-1)" x="0" y="1"-->
                                <!--width="78" height="17" rx="8"></rect>-->
                          <!--<text id="web-Master" font-family="RobotoSlab-Regular, Roboto Slab" font-size="13"-->
                                <!--font-weight="normal">-->
                            <!--<tspan x="5" y="14" fill="#FFFFFF">-->
                              <!--<tspan dx="-1" class="wm-tl">w</tspan>-->
                              <!--<tspan dx="-3" class="wm-tl">e</tspan>-->
                              <!--<tspan dx="-3" class="wm-tl">b</tspan>-->
                            <!--</tspan>-->
                            <!--<tspan x="30.2636719" y="14" fill="#FF981C">-->
                        ...
                        <!--<g id="stripped-logo-text" transform="translate(0.000000, 24.000000)">-->
                          ...
                          <!--<g id="stripped-n" transform="translate(80.000000, 9.000000)">-->
                            ...
                            <!--</mask>-->
                            <!--<use id="n-mask" fill="#1D60B5" xlink:href="#path-2"></use>-->
                            <!--<g id="stripe" mask="url(#mask-3)">-->
                              <!--<g transform="translate(-2.000000, 0.000000)">-->
                                <!--<rect id="Rectangle-134" fill="#1D60B5" x="1" y="0" width="17" height="20"></rect>-->
                                <!--<rect id="Rectangle-130" fill="#CD2E41" x="0" y="6" width="21" height="2"></rect>-->
                                <!--<rect id="Rectangle-130" fill="#CD2E41" x="0" y="10" width="21" height="2"></rect>-->
                                <!--<rect id="Rectangle-130" fill="#CD2E41" x="0" y="14" width="21" height="2"></rect>-->
                                <!--<rect id="Rectangle-130" fill="#CD2E41" x="0" y="18" width="21" height="2"></rect>-->
                                <!--<rect id="Rectangle-130" fill="#CD2E41" x="0" y="2" width="21" height="2"></rect>-->
                              <!--</g>-->
                            <!--</g>-->
                          <!--</g>-->
                        <!--</g>-->
                    ...
                    <!--<g id="adminoid/header/full/logo/man-new">-->
                      <!--<g id="man-full">-->
                        ...
                        <!--<g id="body-head" transform="translate(7.000000, 0.000000)">-->
                          ...
                          <!--<g id="eye-pupil" transform="translate(8.000000, 31.000000)" style="opacity:0">-->
                            <!--<path-->
                                <!--d="M5,10 C7.76142375,10 10,7.76142375 10,5 C10,2.23857625 7.76142375,-3.55271368e-15 5,-3.55271368e-15 C2.23857625,-3.55271368e-15 0,2.23857625 0,5 C0,7.76142375 2.23857625,10 5,10 Z"-->
                                <!--id="eye" fill="#FFFFFF"></path>-->
                            <!--<path-->
                                <!--d="M6,6 C7.1045695,6 8,5.1045695 8,4 C8,2.8954305 7.1045695,2 6,2 C4.8954305,2 4,2.8954305 4,4 C4,5.1045695 4.8954305,6 6,6 Z"-->
